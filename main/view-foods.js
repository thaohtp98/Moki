...
var elements = document.getElementsByClassName('col-flex');
...
function listView() {
  for (i = 0; i < elements.length; i++) {
    ...
    var elems = document.getElementsByClassName('card_food');
  ...
  for (i = 0; i < elements.length; i++) {
    ...
    var elems = document.getElementsByClassName('card_food');
      for (var i=0;i<elems.length;i+=1){
        ...
        elems[i].children[0].style.height = '170px';
...
var btns = container.getElementsByClassName('btn_');
